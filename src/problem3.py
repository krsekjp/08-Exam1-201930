...
def run_test_problem3a():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   problem3a  function: IGNORE')
    print('--------------------------------------------------')
...
def problem3a(a, b):
    ...
    for k in range(a**b - a):
        if is_prime(a+k) == True:
            if is_prime(sum_of_digits(a+k)) == True:
                total = total + (a+k)
    return total
...
def problem3b(m, x):
    ...
    for k in range(m**4 - m*2):
        if is_prime(m**2 + k) == True:
            if is_prime(sum_of_digits(m**2 + k)) == True:
                if (m**2 + k) >= x:
                    return True
                else:
                    return False
